...
ActiveRecord::Schema.define(version: 20140404062231) do
  ...
  add_index "blocks", ["state"], name: "index_blocks_on_state", using: :btree
  ...
  create_table "column_spaces", force: true do |t|
    t.string   "name",                   null: false
    t.string   "mark",                   null: false
    t.string   "content"
    t.string   "desc"
  ...
  add_index "column_spaces", ["kind"], name: "index_column_spaces_on_kind", using: :btree
  add_index "column_spaces", ["mark"], name: "index_column_spaces_on_mark", unique: true, using: :btree
  add_index "column_spaces", ["name"], name: "index_column_spaces_on_name", using: :btree
  add_index "column_spaces", ["state"], name: "index_column_spaces_on_state", using: :btree
  add_index "column_spaces", ["user_id"], name: "index_column_spaces_on_user_id", using: :btree
  ...
  add_index "columns", ["column_space_id"], name: "index_columns_on_column_space_id", using: :btree
  add_index "columns", ["cover_id"], name: "index_columns_on_cover_id", using: :btree
  add_index "columns", ["kind"], name: "index_columns_on_kind", using: :btree
  add_index "columns", ["sort"], name: "index_columns_on_sort", using: :btree
  add_index "columns", ["state"], name: "index_columns_on_state", using: :btree
  add_index "columns", ["title"], name: "index_columns_on_title", using: :btree
  ...
  add_index "systems", ["mark"], name: "index_systems_on_mark", unique: true, using: :btree
